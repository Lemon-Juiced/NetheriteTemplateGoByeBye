...
import lemon_juice.ntgbb.world.inventory.ModMenuTypes;
...
@Mod(NetheriteTemplateGoByeBye.MOD_ID)
public class NetheriteTemplateGoByeBye {
    public static final String MOD_ID = "ntgbb";
